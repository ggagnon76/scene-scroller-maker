...
export class SSM_SceneDivider extends FormApplication {
     ...
     * @returns {void}
     */
    async divideScene({imgPath = false, newCompendium = false, compendiumName = false} = {}) {
        ...
        if ( !newCompendium && compendiumName ) pack = getCompendiumPack(compendiumName);
        ...
        switch(choice) {
            ...
            case "4":
                await this._divideScenes.apply(this, [pack]);
                this.close();
                break;
        }
    }
