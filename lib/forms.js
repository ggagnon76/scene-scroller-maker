...
import { confirmDialog } from "./functions.js";
...
export class SSM_SceneDivider extends FormApplication {
    ...
    async _updateObject(event, formData) {
        ...
        // Create all of the scenes in memory and save them in the compendium
        // TO-DO
    ...
    async createCompendium() {
        ...
        const packGet = "world." + this.compName;
        const pack = game.packs.get(packGet);
    ...
    async saveSubSceneTextureToFile(division) {
        ...
        const fileName = encodeURI(division.subSceneName + ".webp");
