...
import { SSM_SceneDivider, SSM_ConvertImage, SSM_ResizeImage, SSM_CropImage, PickScene, polygonOffsetByPixels, SSM_ConfirmationDialog } from "./forms.js";
...
async function spawnDividerForm(useData = false) {
    if ( !useData ) new SSM_SceneDivider({height: "auto"}).render(true);
        ...
        const ssmSD = new SSM_SceneDivider(useData, {height: "auto"});
