...
export class Texture2Polygon {
    ...
    static getVertices() {
        ...
        this.foundVertex = false;
        // Array.prototype.some() will stop iterating when the callback function returns TRUE.
        this.vertices.some((value, key) => {
            // Has this vertex already been fully defined?
            if ( value.first !== null && value.second !== null) return false;
        ...
        this.vertices.some((value, vertexCoord) => {
            // Has this vertex already been fully defined?
            if ( value.first !== null && value.second !== null) return false;
            ...
            if ( trailingCar.length === edgeThreshold ) {
                ...
                if ( leadCar.length === edgeThreshold ) {
                    ...
                    if ( !foundVertex ) return false  // Step to the next known vertex
