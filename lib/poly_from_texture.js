...
export class Texture2Polygon {
    ...
    static getPerimeterPixelsFromTexture() {
        ...
        // This is initializing these variables for the getVertices() method.
    ...
    static async generateDrawingPolygon() {

        function getNewDrawingData(origin) {
