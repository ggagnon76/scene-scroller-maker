...
The V2.0 release enhances existing functionality introduced with V1.0 by:
 ...
 - providing the option to create scenes in the core Scene Folder instead of a compendium (divide scene tool)
 - adding option to save the boundary polygons defining sub-scenes to scene flags, to be able to quickly generate sub-scenes at a later time
