...
The V2.0 release enhances existing functionality introduced with V1.0 by:
 ...
 This initial V2.0 release is being pushed out to fix a bad .CSS definition that is clobbering other module's forms.  Follow up updates will implement further refinements:
